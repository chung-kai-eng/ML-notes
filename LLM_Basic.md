...
- mainly focus on two critical aspects
  - `Retrieval Evaluation`: the accuracy and relevance of the information retrieved by the system (e.g. `HR,, MRR`)
  - `Response Evaluation`: measures the quality and appropriateness of the responses generated by the system based on the retrived information (e.g. `Faithfulness Evaluator, Relevancy Evaluator`)
...
- [View more on the evaluation procedure](https://cookbook.openai.com/examples/evaluation/evaluate_rag_with_llamaindex#question-context-pair-generation)
